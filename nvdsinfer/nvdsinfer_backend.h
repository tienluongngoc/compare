 ...
 *
 * Actual instance of a BackendContext can be created using
 * `createBackendContext` function. This function will create the appropriate
 * BackendContext
...
class TrtBackendContext : public BackendContext {
 ...
 protected:
  ...
  bool canSupportBatchDims(int bindingIdx,
                           const NvDsInferBatchDims& batchDims) override;
